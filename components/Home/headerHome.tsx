  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-black/40 border-b border-white/10 px-6 py-4 flex items-center justify-between">
        <div className="text-xl font-black tracking-tighter text-white w-1/3">
        ...
        <div className="flex justify-center w-1/3">
          <a
            href="https://github.com/lenovix/KMLapp"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-slate-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all text-xs font-medium"
          >
            <Github size={14} />
            <span>GitHub</span>
          </a>
            ...
            <div className="relative">
              ...
              {open && (
                <div className="absolute right-0 mt-3 w-48 bg-[#121212] border border-white/10 shadow-2xl rounded-2xl overflow-hidden backdrop-blur-xl animate-in fade-in zoom-in duration-200">
                  ...
                  <Link
                    href="/report"
                    className="flex items-center gap-2 px-4 py-3 text-sm text-slate-300 hover:bg-white/5 hover:text-white transition-colors border-t border-white/5"
                    onClick={() => setOpen(false)}
                  >
                    <svg
